...
export default function DecryptPage() {
    ...
    const onSubmit = (data: Schema) => {
        ...
        const { result, steps } = cipher.process(data.cipherText, 'decrypt');
    ...
    return (
        <main className="w-full p-4 md:p-8">
            <h1 className="mb-8 text-4xl text-gray-700 font-bold">Decrypt Playfair Cipher</h1>
                ...
                <section className="w-full md:w-2/5 p-4 bg-white border border-gray-500 rounded-lg shadow-2xl">
                    ...
                    >
                        ...
                        <TextArea<Schema>
                            ...
                            errors={errors}
                            placeholder="Message want to be decrypt"
                            defaultValue={''}
                            rows={5}
                            required
                        />
