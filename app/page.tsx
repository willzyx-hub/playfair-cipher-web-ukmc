...
export default function Home() {
    ...
    return (
        <main className="h-screen flex flex-col justify-center items-center p-4 md:p-20">
            <svg className="fixed -z-10 top-10 md:top-20 left-10 md:left-20 size-24 text-slate-700 dark:text-white animate-bounce opacity-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <svg className="fixed  -z-10 bottom-10 md:bottom-20 right-10 md:right-20 size-24 text-slate-700 dark:text-white animate-bounce opacity-50" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
